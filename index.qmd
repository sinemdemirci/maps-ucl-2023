...
{{< fa link >}} <a href = "http://minedogucu.com" style="font-size: 28px; line-height: 0.5;">minedogucu.com</a>  
{{< fa brands github >}} <a href = "http://github.com/mdogucu" style="font-size: 28px; line-height: 0.5;">mdogucu</a>       
{{< fa brands twitter >}} <a href = "http://twitter.com/MineDogucu" style="font-size: 28px; line-height: 0.5;">MineDogucu</a>     
{{< fa brands mastodon >}} <a href = "https://mastodon.social/@MineDogucu" style="font-size: 28px; line-height: 0.5;">mastodon.social/@MineDogucu</a>  
{{< fa brands linkedin >}} <a href = "https://www.linkedin.com/in/minedogucu/" style="font-size: 28px; line-height: 0.5;">minedogucu</a> 
...
::: {.column width="40%"}
::: fragment
![](img\teaching-01.jpg){fig-align="center" width="60%"} ![](img\teaching-02.jpg){fig-align="center" width="80%"}
:::
:::
...
![Figure 2. Hexagon model of pedagogical content knowledge for science teaching (Park & Oliver,2008, p.279)](img\pck-park-oliver-2008.png){fig-align="center" width="100%"}
...
::: fragment
![](img\exploratory.PNG){fig-align="center" width="60%"}
...
::: {style="font-size: 24px"}
::: fragment
![Sample map of Park and Oliver, 2012](img\sample-map-park-oliver.png){fig-align="center" width="80%"}
:::
:::
:::
::::
...
:::fragment
![Figure 5. An example of PCK Map](img\map-12.png){fig-align="center" width="70%"}
:::
:::
...
::: {style="font-size: 28px"}
- In summary of our key findings, we examined the components of PCK of IDS instructors 
